...
def insert_in_couchdb(key, dicom_dataset):
    ...
    dados_serie = {'id': id_serie, 'descricaoSerie': desc_serie}
    ...
    dados_imagem = {'id': id_imagem, 'peakVoltage': peak_voltage, 'exposureTime': exposure_time,
    ...
    if documento_paciente:
        ...
        if not exame:
            ...
            dados_serie['imagens'] = [dados_imagem]
            dados_exame['series'] = [dados_serie]
            ...
            if not serie:
                ...
                # Cria a serie com as informacoes iniciais
                dados_serie['imagens'] = [dados_imagem]
